...
<?php foreach ($update_answer as $anw): ?>
<title>Update Answer - <?php echo $this->config->item('web_name'); ?></title>
        ...
        <div class="warapper-border" data-text="Answer">
            ...
            <div class="padding10" style="line-height: 25px;">
                ...
                <?php echo form_open($this->uri->uri_string()); ?>
                    <label for="description_answer">Description Answer</label>
                    <div class="input-control textarea full-size" data-role="input">
                        <?php echo form_textarea('description_answer', $anw->description_answer); ?>
                    </div>
                    <hr>
                    <div class="form-actions">
                        <div class="fc">
                            <?php echo form_submit('submit', 'Update Answer', 'class="button success large-button"'); ?>
