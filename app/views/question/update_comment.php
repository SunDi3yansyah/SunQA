...
<?php foreach ($update_comment as $anw): ?>
<title>Update Comment - <?php echo $this->config->item('web_name'); ?></title>
            ...
            <div class="padding10" style="line-height: 25px;">
                ...
                <?php echo form_open($this->uri->uri_string()); ?>
                    ...
                    <div class="input-control textarea full-size" data-role="input">
                        <?php echo form_textarea('description_comment', $anw->description_comment); ?>
                    </div>
                    <hr>
                    <div class="form-actions">
                        <div class="fc">
                            <?php echo form_submit('submit', 'Update Comment', 'class="button success large-button"'); ?>
