...
<title>Comment Answer - <?php echo $this->config->item('web_name'); ?></title>
<script src="<?php echo assets_js('select2.min.js'); ?>"></script>
</head>
<body>
<?php $this->load->view('must/menu'); ?>
    <div class="container page-content">
        <h1 class="title_qa">Comment Answer</h1>
            ...
            <div class="padding10" style="line-height: 25px;">
                ...
                <?php echo form_open($this->uri->uri_string()); ?>
                    ...
                    <div class="form-actions">
                        <div class="fc">
                            <?php echo form_submit('submit', 'Comment Answer', 'class="button success large-button"'); ?>
