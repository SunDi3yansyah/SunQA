                    ...
                    <section class="QuestionList">
                        <header class="QuestionList-header">
                            ...
                            <p class="QuestionList-meta">
                                By <a class="QuestionList-author" href="<?php echo base_url('user/' . $q->username); ?>"><?php echo $q->nama ?></a> under <a class="QuestionList-category QuestionList-category-js" href="<?php echo base_url('category/' . uri_encode($q->category_name)); ?>"><?php echo $q->category_name ?></a> created <?php echo dateHourIcon($q->question_date) ?>
                            </p>
                        </header>
