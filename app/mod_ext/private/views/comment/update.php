                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <p>
                                        Komentar ini ditujukan untuk pertanyaan <b><?php echo $data->subject ?></b>
                                        <br>
                                        Dan komentar pada parent <button type="button" class="btn btn-outline btn-primary btn-xs"><?php echo $data->comment_in ?></button>
                                    </p>
                                </div>
                            </div>
                            <div class="alert alert-info">
                                Detail Author :
                                <ul>
                                    <li>Submited : <b><?php echo dateHourStripe($data->comment_date) ?></b></li>
                            ...
                            <div class="fc">
                                <a href="<?php echo base_url('question/' . $data->url_question . '#comment-' . $data->id_comment) ?>" target="_blank" class="btn btn-primary btn-lg">See <?php echo $this->uri->segment(2) ?></a>
                            </div>
                        </div>
                    </div>
                </div>
