                    ...
                    <div class="row">
                        ...
                        <?php endif ?>
                            <?php echo form_open($this->uri->uri_string(), 'role="form"'); ?>
                                <div class="form-group">
                                    ...
                                    <?php echo form_input('category_name', $data->category_name, 'class="form-control" autocomplete="off"'); ?>
                                </div>
                        ...
                        <div class="col-lg-6">
                            <div class="panel panel-info">
                                ...
                                <div class="panel-body">
                                    <p>
                                        Question yang memiliki kategori <b><?php echo $data->category_name ?></b> sebanyak
                                        <b>
                            ...
                            <div class="fc">
                                <a href="<?php echo base_url('category/' . uri_encode($data->category_name)) ?>" target="_blank" class="btn btn-primary btn-lg">See <?php echo $this->uri->segment(2) ?></a>
                            </div>
                        </div>
                    </div>
                </div>
